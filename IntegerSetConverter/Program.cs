...
namespace IntegerSetConverter
{
    ...
    class Program
    {
        static void TestIntegerToString(INumericConverter aConverter)
        {
            ///                                                                                    
            ...
            foreach (var S in Sets)
            {
                BeginTest(S.Key);
                    ...
                    IntroduceConverter(aConverter, "int[] -> string");
        ...
        static void TestStringToInteger(INumericConverter aConverter)
        {
            ///                                                                                    
            ///   Создание наборов данных. 
            ///____________________________________________________________________________________
            ...
            foreach (var S in Sets)
            {
                BeginTest(S.Key);
                    ...
                    IntroduceConverter(aConverter, "string -> int[]");
        ...
        AskNumber:
            ...
            TestIntegerToString(CSet[CKey]);

            ///   Тест преобразования строки в числовой набор. 
            TestStringToInteger(CSet[CKey]);
        ...
        static void BeginTest (string aName, string aDescription = "")
        {
            Console.WriteLine(String.Format
            (
                "{0} {1} {0}",
        ...
        static void IntroduceConverter (INumericConverter aConverter, string aMethod)
        {
